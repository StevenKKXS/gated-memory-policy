...
METHOD_LABEL=gru_conditional_burnin
...
LANES=(
  $'rc3_burn\t0\t32710\tmikasa_remember_color_3\tRememberColor3-v0\t'"$BASE_RC3"$'\t7\t6\t10\t10\t8\t2\ttail\tnone'
  $'rc5_burn\t1\t32711\tmikasa_remember_color_5\tRememberColor5-v0\t'"$BASE_RC5"$'\t7\t6\t10\t10\t8\t2\ttail\tnone'
  $'rc9_burn\t2\t32712\tmikasa_remember_color_9\tRememberColor9-v0\t'"$BASE_RC9"$'\t7\t6\t10\t10\t8\t2\ttail\t1'
  $'intercept_burn\t3\t32713\tmikasa_intercept_medium\tInterceptMedium-v0\t'"$BASE_INTERCEPT"$'\t13\t12\t8\t8\t16\t4\ttail\t1'
  $'shell_burn\t4\t32714\tmikasa_shell_game_touch\tShellGameTouch-v0\t'"$BASE_SHELL"$'\t46\t45\t2\t10\t8\t8\ttail\tnone'
)
