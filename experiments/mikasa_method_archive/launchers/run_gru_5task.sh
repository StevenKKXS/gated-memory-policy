...
LANES=(
  $'rc3\t0\t32610\tmikasa_remember_color_3\tRememberColor3-v0\t'"$BASE_RC3"$'\t6\t5\t10\t10\t0\t0\trandom\tnone'
  $'rc5\t1\t32611\tmikasa_remember_color_5\tRememberColor5-v0\t'"$BASE_RC5"$'\t6\t5\t10\t10\t0\t0\trandom\tnone'
  $'rc9\t2\t32612\tmikasa_remember_color_9\tRememberColor9-v0\t'"$BASE_RC9"$'\t6\t5\t10\t10\t0\t0\trandom\tnone'
  $'intercept\t3\t32613\tmikasa_intercept_medium\tInterceptMedium-v0\t'"$BASE_INTERCEPT"$'\t12\t11\t8\t8\t0\t0\trandom\tnone'
  $'shell\t4\t32614\tmikasa_shell_game_touch\tShellGameTouch-v0\t'"$BASE_SHELL"$'\t45\t44\t2\t10\t0\t0\trandom\tnone'
)
